...
class ImageNet(ImageFolder, ClassificationDataset):
    ...
    def __init__(self, root, **kwargs):
        ...
        ImageFolder.__init__(self, root=root, **kwargs)
        ClassificationDataset.__init__(self)

    def __getitem__(self, idx):
        sample, target = super().__getitem__(idx)
        target_label = self.id_to_name[target]
        return {
            "id": int(idx),
            "image": sample,
            "class_id": target,  # numeric ID of the ImageNet class
            "label": target_label,  # human-readable name of ImageNet class
        }
