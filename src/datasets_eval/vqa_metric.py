# Code adapted from https://github.com/mlfoundations/open_flamingo/eval/vqa_metric.py
...
# This code is based on the code written by Tsung-Yi Lin for MSCOCO Python
# API available at the following link:
...
class VQA:
    def __init__(self, annotation_file=None, question_file=None):
        """
        Constructor VQA helper class for reading and visualizing questions and answers.
    ...
    def loadRes(self, resFile, quesFile):
        ...
        [ann["question_id"] for ann in anns]
        ...
        # predictions for all question ids in annotation file or there is atleast one
...
def compute_vqa_accuracy(result_json_path, question_json_path, annotation_json_path):
    ...
    pass it as a list to below function
