# import json
# from llavaextend import LlavaInferExtended
...
#     # 结果保存路径
#     output_json_path = '/data/jyh/multimodal-icl/llava_predict_results/llava_result_shot_1.json'
...
#     # 初始化模型
#     model = LlavaInferExtended()
#     model.initialize(model_id="/data/jyh/multimodal-icl/llava-1.5-7b-hf")  # 确保这里指向正确的模型路径
...
#         results.append({
#             "query_id": query["id"],
#             "predicted_sentiment": result.strip(),
